...
if __name__ == '__main__':
    ...
    x=data.iloc[:,:2]    #切取数据
    n, features = x.shape #记录数和特征数
    y=data.iloc[:,-1].astype(np.int) #修改数据类型
    ...
    models= [
        ...
        ['LR',LogisticRegressionCV(Cs=alpha,penalty ='l2',cv =3)], #penalty 指定正则化为l2，Cs指定超参
    ...
    colors = cycle('gmcr') #生成g,m,c,r 数组
    print colors
